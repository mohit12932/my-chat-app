  ...
  return (
    ...
    <path d="M20 11C20 6.02944 15.9706 2 11 2C6.02944 2 2 6.02944 2 11C2 15.9706 6.02944 20 11 20C15.9706 20 20 15.9706 20 11Z" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round" />
        ...
        {errors.NoUser && <p className="text-sm  mt-2 text-center text-red-400">{errors.NoUser.message}</p>}
         ...
         <div  className="flex items-center w-full px-5 py-2 transition-colors duration-200 hover:bg-gray-800 gap-x-2  focus:outline-none">
          <Image width={500} height={300} className="object-cover w-8 h-8 rounded-full" src={Friend.Profile} alt=""/>
          <h1 className="text-sm font-medium text-white">{Friend.Username}</h1>
         </div>
        <button className="px-3 hover:border rounded-full" onClick={addFriend}>
