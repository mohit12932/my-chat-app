...
<div className="flex flex-col items-center w-16 h-[90vh] py-8 space-y-8  bg-[#0b0d26] border-gray-700 rounded-lg">
        <a href="#">
            <Image width={500} height={300} className="w-auto h-6" src="https://merakiui.com/images/logo.svg" alt=""/>
        </a>

        <a href="#" ref={linkRef} className="p-1.5 focus:text-blue-500 focus:bg-gray-800 focus:outline-nones transition-colors duration-200 rounded-lg text-gray-400 hover:bg-gray-800" onClick={()=>setNav('1')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
                <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 12l8.954-8.955c.44-.439 1.152-.439 1.591 0L21.75 12M4.5 9.75v10.125c0 .621.504 1.125 1.125 1.125H9.75v-4.875c0-.621.504-1.125 1.125-1.125h2.25c.621 0 1.125.504 1.125 1.125V21h4.125c.621 0 1.125-.504 1.125-1.125V9.75M8.25 21h8.25" />
            </svg>
        </a>

        <a href="#" className="p-1.5 focus:text-blue-500 focus:bg-gray-800 focus:outline-nones transition-colors duration-200 rounded-lg text-gray-400 hover:bg-gray-800"onClick={()=>setNav('2')}>
            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-6 h-6">
        ...
        <Image width={500} height={300} className="object-cover w-8 h-8 rounded-full" src={me.Profile}  alt=""/>
        </a>
    </div>
